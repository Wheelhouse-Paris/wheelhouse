...
mod ac2_incoming_message {
    ...
    fn incoming_message_produces_text_message_with_user_id() {
        ...
        assert_eq!(msg.user_id, Some("usr_abc123".to_string()));
    }
...
mod ac3_outgoing_response {
    ...
    fn text_message_reply_to_user_id_routes_response() {
        ...
        let msg = wh_proto::TextMessage {
            ...
            publisher: "donna-agent".to_string(),
            timestamp: "2026-03-12T10:00:05Z".to_string(),
            user_id: None,
            reply_to_user_id: Some("usr_abc123".to_string()),
        };
        assert_eq!(msg.reply_to_user_id, Some("usr_abc123".to_string()));
    }
}
