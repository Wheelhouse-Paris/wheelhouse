...
_LOCK_STALE_AFTER_S = 300.0  # ADR-040: 5-minute stale window
...
class LibrarySandbox:
    ...
    def __init__(
        ...
        *,
        ...
        # Story 13-6: sleep seam so unit tests can drive the retry loop
        # in microseconds instead of real wall-clock seconds. The
        # production default is unconditionally `time.sleep`.
